...
Page({
    ...
    onInput: function(e) {
        ...
        } else if (e.target.dataset.prop == "focusSpecialEvent") {
            this.setData({
                focusSpecialEvent: e.detail.value
            })
        } else if (e.target.dataset.prop == "focusBriefHistory") {
            this.setData({
                focusBriefHistory: e.detail.value
            })
